...
SECRET_KEY = 'django-insecure-uf8@j)0p(k)8_&jz(zg%&ll%!sw=+7g%7h*w!jpx8h80@itl4='
...
INSTALLED_APPS = [
    ...
    'contact', # my_project/contact/apps.py
]
...
TEMPLATES = [
    {
        ...
        'DIRS': [
            BASE_DIR / 'base_templates' # my_project/base_templates
        ],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
LANGUAGE_CODE = 'en-us' # Pode ser 'pt-br' ou en-us.

TIME_ZONE = 'UTC' # 'America/Sao_paulo'

USE_I18N = True # Internacionalization.
...
try:
    from schedule.local_settings import *
except ImportError:
    ...