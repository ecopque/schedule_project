...
class cls_contactform(forms.ModelForm):
    ...
    first_name = forms.CharField(widget=forms.TextInput(attrs={'class': 'class-a class-b', 'placeholder': 'Write here3',}), label='First Nameee', help_text='Help text.') ##BBB: ##CCC: # my_project/contact/templates/contact/create.html
